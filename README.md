...
Here's a to do list, each of you pick one task to do(put your name next to the task): <br>
...
6. Create a simple page for each group( Upload a picture that represents the spirit your team; Add the names of each team member; link your name to the resume) </br>
